...
* @class WSsock
* @extends {Namespace}
* @desc WSock class for create server and manage namespaces
*/

var WSock = function (_Namespace) {
  _inherits(WSock, _Namespace);
  ...
  */
  function WSock(_ref) {
    ...
    _classCallCheck(this, WSock);

    /**
    * @type {Number}
    * @desc Server port
    */
    var _this = _possibleConstructorReturn(this, (WSock.__proto__ || Object.getPrototypeOf(WSock)).call(this, { name: 'root' }));
  ...
  */
  ...
  _createClass(WSock, [{
    key: '_boot',
    value: function _boot(namespace) {
